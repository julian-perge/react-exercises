...
const listOfArticles = [
  ...
  },
  {
    ...
    link: "https://lemire.me/blog/2018/10/19/validating-utf-8-bytes-using-only-0-45-cycles-per-byte-avx-edition/",
    upvotes: 98,
    user: {
      name: "akarambir"
    },
  ...
  },
  {
    ...
    link: "https://www.wired.com/story/these-new-tricks-can-outsmart-deepfake-videosfor-now/",
    upvotes: 58,
    user: {
      name: "joewee"
    },
...
ReactDOM.render(<NewsList articles={listOfArticles} />, document.getElementById("root"));
